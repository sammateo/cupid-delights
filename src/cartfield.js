...
export default function Cartfield({option1,option2,total1,total2,total,name1,name2, quantity, nextDay}){   
    ...
    return(
        <div className={styles.container} >
                ...
                <p>Shipping: {(quantity >= 5 && quantity <= 12 && !nextDay)?formatter.format(shipping1):
                (quantity >=13 && quantity <=19 && !nextDay)?formatter.format(shipping2):
                (quantity >=20 && quantity <=40&& !nextDay)?formatter.format(shipping3):
                (quantity >= 5 && quantity <= 12 && nextDay)?formatter.format(nextshipping1):
                (quantity >=13 && quantity <=19 && nextDay)?formatter.format(nextshipping2):
                (quantity >=20 && quantity <=40&& nextDay)?formatter.format(nextshipping3):
